...
.notune:	ld	de,IDX_CREDITS1PKG
		...
		call	.sh1
		ld	de,IDX_CREDITS8PKG
		call	.sh1
		ld	de,IDX_CREDITS9PKG
		call	.sh1
		ld	de,IDX_CREDITS10PKG
		call	.sh1
		ld	de,IDX_CREDITS11PKG
		call	.sh1
		ld	de,IDX_CREDITS12PKG
		call	.sh1
		ld	de,IDX_HERSHEYPKG
		call	.sh1
		jp	menutune
.sh1:		push	de
		call	SetBitmap20x18
