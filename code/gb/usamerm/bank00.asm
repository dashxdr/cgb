...
; ** Bank $02 -                         Bank $22 - FileSys                 **
; ** Bank $03 -                         Bank $23 - FileSys                 **
; ** Bank $04 -                         Bank $24 - FileSys                 **
...
; ** Bank $14 - Sprites                 Bank $34 -                         **
; ** Bank $15 - FileSys                 Bank $35 -                         **
; ** Bank $16 - FileSys                 Bank $36 -                         **
; ** Bank $17 - FileSys                 Bank $37 -                         **
; ** Bank $18 - FileSys                 Bank $38 -                         **
; ** Bank $19 - FileSys                 Bank $39 -                         **
; ** Bank $1A - FileSys                 Bank $3A -                         **
; ** Bank $1B - FileSys                 Bank $3B -                         **
; ** Bank $1C - FileSys                 Bank $3C -                         **
; ** Bank $1D - FileSys                 Bank $3D -                         **
; ** Bank $1E - FileSys                 Bank $3E -                         **
; ** Bank $1F - FileSys                 Bank $3F -                         **
; **                                                                       **
; ***************************************************************************
; ***************************************************************************
; ***************************************************************************
...
;		LD	A,BANK(MzRefresh1)	;Process 60Hz music refresh.
;		LDH	[hRomBank],A		;
;		LD	[rMBC_ROM],A		;
;		CALL	MzRefresh1		;

		LD	A,[wMzBank]		;Process 60Hz music refresh.
		LDH	[hRomBank],A		;
		LD	[rMBC_ROM],A		;
		CALL	wMzRefresh		;
...
; ***************************************************************************
		...
		DB	$DD,$DC,$99,$9F
		DB	$BB,$B9,$33,$3E
		DB	"P","N","B","A"		;$0134 Game title.
		DB	"L","F","R","E"
		DB	"N","Z","Y"
		DB	"V","M","2","E"		;$013f Game code. (USA version)
//		DB	"B","Y","2","P"		;$013F Game code. (Japanese version)
		DB	$C0			;$0143 CGB function code.
		DB	$30,$31			;$0144 Maker code.
		DB	$00			;$0146 SGB function code.
		DB	$1E			;$0147 Cartridge type. (USA)
//		DB	$1B			;$0147 Cartridge type. (J)
...
InitTune::	LD	B,A
		...
		CP	10
		JR	NC,.secondbank
.firstbank:	LD	A,BANK(InitTuneB1)
		LDH	[hRomBank],a
		LD	[rMBC_ROM],a
		CALL	SetMz1
		LD	A,B
		...
		LD	[rMBC_ROM],a
		RET
.secondbank:	LD	A,BANK(InitTuneB2)
		LDH	[hRomBank],a
		LD	[rMBC_ROM],a
		CALL	SetMz2
		LD	A,B
...
SetMz1::
		LD	HL,wMzBank
		LD	A,BANK(MzRefresh1)
		LD	[HLI],a
		LD	A,$C3
		LD	[HLI],A
		LD	A,LOW(MzRefresh1)
		LD	[HLI],A
		LD	A,HIGH(MzRefresh1)
		LD	[HLI],A
		RET

SetMz2::
		LD	HL,wMzBank
		LD	A,BANK(MzRefresh2)
		LD	[HLI],a
		LD	A,$C3
		LD	[HLI],A
		LD	A,LOW(MzRefresh2)
		LD	[HLI],A
		LD	A,HIGH(MzRefresh2)
		LD	[HLI],A
		RET
...
b_start		EQUS	"wShellLastVariable+00"
b_clock		EQUS	"wShellLastVariable+00"
b_1		EQUS	"wShellLastVariable+08"
b_2		EQUS	"wShellLastVariable+16"
b_3		EQUS	"wShellLastVariable+24"
b_4		EQUS	"wShellLastVariable+32"
b_5		EQUS	"wShellLastVariable+40"
b_6		EQUS	"wShellLastVariable+48"
b_7		EQUS	"wShellLastVariable+56"
b_8		EQUS	"wShellLastVariable+64"
b_9		EQUS	"wShellLastVariable+72"
b_10		EQUS	"wShellLastVariable+80"
b_end		EQUS	"wShellLastVariable+88"
